    ...
    def actress_data(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "listURL": {
                ...
                "lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmonthly%2Fpremium%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1017139%2F&af_id=***REDACTED_AFF_ID***&ch=api",
                "mono": "https://al.fanza.co.jp/?"
                "lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmono%2Fdvd%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1017139%2F&af_id=***REDACTED_AFF_ID***&ch=api",
            },
        }
...
class TestActressSearchResultDetailedFields(ActressSearchResultTestBase):
    """Test implementation for actress search result with detailed fields."""
    ...
    def test_result_actress_list(self, result_data: Dict[str, Any]) -> None:
        ...
        assert result.actresses[0].id == 1017139
    ...
    def test_result_nested_actresses(self, result_data: Dict[str, Any]) -> None:
        ...
        assert result.actresses[0].name == "蓮実クレア"
...
class TestActressSearchResponseDetailedFields(ActressSearchResponseTestBase):
    """Test implementation for actress search response with detailed fields."""
                ...
                "actress": [
                    {
                        ...
                        "listURL": {
                            "digital": "https://al.fanza.co.jp/?lurl=https%3A%2F%2Fvideo.dmm.co.jp%2Fav%2Flist%2F%3Factress%3D1017139%2F&af_id=***REDACTED_AFF_ID***&ch=api",
                            "monthly": "https://al.fanza.co.jp/?lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmonthly%2Fpremium%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1017139%2F&af_id=***REDACTED_AFF_ID***&ch=api",
                            "mono": "https://al.fanza.co.jp/?lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmono%2Fdvd%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1017139%2F&af_id=***REDACTED_AFF_ID***&ch=api",
                        },
                    }
                ],
            },
    ...
    def test_response_actresses_property(self, response_data: Dict[str, Any]) -> None:
        ...
        assert response.actresses[0].name == "蓮実クレア"
