"""
Test GenreSearchResponse with FANZA DVD floor data.
"""
...
class TestGenreSearchResponseDVD(GenreSearchResponseTestBase):
    """Test GenreSearchResponse with FANZA DVD floor data."""
    ...
    def test_response_from_dict(self, response_data: Dict[str, Any]) -> None:
        ...
        assert response.result.service_code == "mono"
