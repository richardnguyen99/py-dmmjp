"""
Test for actress search functionality.
"""
...
class TestActressWithEmptyFields(ActressTestBase):
    """Test implementation for actress functionality."""

    @pytest.fixture
    def actress_data(self) -> Dict[str, Any]:
        """Mock actress data for testing - individual actress item from DMM API response."""
        return {
            "id": "1099472",
            "name": "瀬戸環奈",
            "ruby": "せとかんな",
    ...
    def test_actress_basic_fields(self, actress_data: Dict[str, Any]) -> None:
        ...
        assert actress.id == 1099472
        assert actress.name == "瀬戸環奈"
        assert actress.ruby == "せとかんな"
    ...
    def test_actress_measurements(self, actress_data: Dict[str, Any]) -> None:
        ...
        assert actress.waist is None
        assert actress.hip is None
        assert actress.height is None
        assert actress.cup is None
    ...
    def test_actress_personal_info(self, actress_data: Dict[str, Any]) -> None:
        ...
        assert actress.hobby == ""
        assert actress.prefectures == ""
    ...
    def test_actress_image_urls(self, actress_data: Dict[str, Any]) -> None:
        ...
        assert (
            ...
            == "http://pics.dmm.co.jp/mono/actjpgs/thumbnail/seto_kanna.jpg"
        )
        assert (
            actress.image_url.large
            == "http://pics.dmm.co.jp/mono/actjpgs/seto_kanna.jpg"
        )
    ...
    def test_actress_image_url_from_dict(self, actress_data: Dict[str, Any]) -> None:
        ...
        assert "seto_kanna.jpg" in image_url.small
        assert "seto_kanna.jpg" in image_url.large
    ...
    def test_actress_blood_type_data(self, actress_data: Dict[str, Any]) -> None:
        ...
        test_data = {"id": "1", "name": "Test", "blood_type": "A"}
        actress = Actress.from_dict(test_data)
            ...
            "actress": [
                {
                    ...
                    "listURL": {
                        ...
                        "lurl=https%3A%2F%2Fvideo.dmm.co.jp%2Fav%2Flist%2F%3Factress%3D1099472%2F&af_id=10278-996&ch=api",
                        "monthly": "https://al.fanza.co.jp/?"
                        "lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmonthly%2Fpremium%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1099472%2F&af_id=10278-996&ch=api",
                        "mono": "https://al.fanza.co.jp/?"
                        "lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fmono%2Fdvd%2F-%2Flist%2F%3D%2Farticle%3Dactress%2Fid%3D1099472%2F&af_id=10278-996&ch=api",
