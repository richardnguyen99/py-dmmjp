"""
Tests for maker data models using VideoA floor (floor_id=43) data.
"""
...
class TestMakerVideoA(MakerTestBase):
    """Test Maker class with VideoA floor data."""
    ...
    def test_maker_basic_fields(self, maker_data: Dict[str, Any]) -> None:
        ...
        assert maker.maker_id == "5786"
        assert maker.name == "1Z1"
        assert maker.ruby == "1ぜっと1"
        assert "maker%3D5786" in maker.list_url
    ...
    def test_maker_default_values(self, maker_data: Dict[str, Any]) -> None:
        partial_data = {"maker_id": "5786"}
        maker = Maker.from_dict(partial_data)
        assert maker.maker_id == "5786"
        assert maker.name == ""


class TestMakerSearchResultVideoA(MakerSearchResultTestBase):
    """Test MakerSearchResult class with VideoA floor data."""
    ...
    def test_result_basic_fields(self, result_data: Dict[str, Any]) -> None:
        ...
        assert result.total_count == 4739
    ...
    def test_result_nested_makers(self, result_data: Dict[str, Any]) -> None:
        ...
        assert first_maker.maker_id == "5786"
        assert first_maker.name == "1Z1"
...
class TestMakerSearchResponseVideoA(MakerSearchResponseTestBase):
    """Test MakerSearchResponse class with VideoA floor data."""
    ...
    def test_response_total_makers_property(
        ...
        response = MakerSearchResponse.from_dict(response_data)
        assert response.total_makers == 4739
